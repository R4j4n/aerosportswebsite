...
export async function generateMetadata({ params }) {
  ...
  // Customize the metadata for the pricing table page
  return {
    ...metadata,
    title: `Pricing Table - ${params.location_slug} | AeroSports`,
    description: `View our detailed pricing table for ${params.location_slug} location. Compare packages and find the best deal for your adventure.`,
  };
}
